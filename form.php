<?php 
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      //query SQL
      $query = "INSERT INTO minimarket (SKU, nama_barang, kategori, jumlah_stok, harga_satuan) VALUES('$SKU','$nama_barang','$kategori','$jumlah_stok','$harga_satuan')"; 
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <form action="form.php" method="POST">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="jumlah_stok" required="required"></textarea>
            </div>
            <div class="form-group">
